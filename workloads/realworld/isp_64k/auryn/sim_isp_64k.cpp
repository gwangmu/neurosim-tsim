...
#define NE 51200 //!< Number of excitatory neurons
#define NI 12800 //!< Number of inhibitory neurons
#define NP 6400 //!< Number of Poisson input neurons
...
int main(int ac, char* av[]) 
{
    ...
    try {
        ...
        desc.add_options()
            ...
            ("bg", po::value<double>(), "background current")
        ;
