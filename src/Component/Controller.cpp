...
#include <TSim/Module/ICController.h>
    ...
    : Component ("Controller", iname, parent)
{
    ...
    Module *ic_controller = new ICController ("ic_controller", this, "pcie", 
    ...
    ic_controller->Connect ("tx", pkt_send->GetEndpoint (Endpoint::RHS));

    ic_controller->Connect ("rx", pkt_recv->GetEndpoint (Endpoint::LHS));
    ...
    // gwangmu
    ExportPort ("TxExport", ic_controller, "tx_export");
    ExportPort ("RxImport", ic_controller, "rx_import");
}
