    ...
    : Component ("NeuroCore", iname, parent)
{
    ...
    accumulator->Connect("synapse", Endpoint::PORTCAP());//synapse_info->GetEndpoint (Endpoint::RHS));
    ...
    syn_queue->Connect("acc", Endpoint::PORTCAP());//synapse_info->GetEndpoint (Endpoint::LHS));
